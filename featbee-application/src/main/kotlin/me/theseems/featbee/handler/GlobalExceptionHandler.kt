package me.theseems.featbee.handler

import me.theseems.featbee.handler.captcha.InvalidCaptchaException
...
class GlobalExceptionHandler {
    ...
    fun handleInvalidCaptcha(exception: InvalidCaptchaException): ResponseEntity<Map<String, Any?>> {
        return ResponseEntity.badRequest()
            .body(
                mapOf(
                    "success" to false,
